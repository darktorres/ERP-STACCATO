...
namespace {
LimeReport::ObjectPropItem *createStringPropItem(QObject *object, LimeReport::ObjectPropItem::ObjectsList *objects, const QString &name, const QString &displayName, const QVariant &data,
...
QWidget *StringPropItem::createProperyEditor(QWidget *parent) const { return new ButtonLineEditor(object()->objectName() + "." + displayName(), parent); }
