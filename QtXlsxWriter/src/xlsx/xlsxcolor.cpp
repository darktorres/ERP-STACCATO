...
bool XlsxColor::isIndexedColor() const { return val.userType() == QMetaType::Int; }
...
QString XlsxColor::toARGBString(const QColor &c) { return c.name(QColor::HexArgb).remove("#"); }
