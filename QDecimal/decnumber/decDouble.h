...
#define decDoubleToNumber(dq, dn) decimal64ToNumber(reinterpret_cast<decimal64 *>(const_cast<decDouble *>(dq)), dn)
#define decDoubleFromNumber(dq, dn, set) decimal64FromNumber(reinterpret_cast<decimal64 *>(dq), dn, set)
