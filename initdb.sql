...
DROP VIEW IF EXISTS `mydb`.`view_fluxo_caixa_pendente` ;
USE `mydb`;
...
DROP VIEW IF EXISTS `mydb`.`view_fluxo_caixa_realizado` ;
USE `mydb`;
...
DROP VIEW IF EXISTS `mydb`.`view_fluxo_resumo_pendente` ;
USE `mydb`;
...
DROP VIEW IF EXISTS `mydb`.`view_fluxo_resumo_realizado` ;
USE `mydb`;
...
DROP VIEW IF EXISTS `mydb`.`view_grafico_loja` ;
USE `mydb`;
...
DROP VIEW IF EXISTS `mydb`.`view_grafico_lojas` ;
USE `mydb`;
...
USE `mydb`$$
DROP TRIGGER IF EXISTS `mydb`.`venda_has_produto_AFTER_DELETE` $$
USE `mydb`$$
CREATE
DEFINER=`root`@`%`
...
USE `mydb`$$
DROP TRIGGER IF EXISTS `mydb`.`venda_has_produto_AFTER_INSERT` $$
USE `mydb`$$
CREATE
DEFINER=`root`@`%`
...
USE `mydb`$$
DROP TRIGGER IF EXISTS `mydb`.`venda_has_produto_AFTER_UPDATE` $$
USE `mydb`$$
CREATE
DEFINER=`root`@`%`
