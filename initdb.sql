...
CREATE TABLE IF NOT EXISTS `staccato`.`config` (
  ...
  `servidorACBr` VARCHAR(45) NULL DEFAULT NULL,
  `portaACBr` VARCHAR(45) NULL DEFAULT NULL,
  `lojaACBr` INT(11) NULL DEFAULT NULL,
  `emailContabilidade` VARCHAR(45) NULL DEFAULT NULL,
  `emailLogistica` VARCHAR(45) NULL DEFAULT NULL,
  `monitorarCNPJ1` VARCHAR(45) NULL DEFAULT NULL,
  `monitorarServidor1` VARCHAR(45) NULL DEFAULT NULL,
  `monitorarPorta1` VARCHAR(45) NULL DEFAULT NULL,
  `monitorarCNPJ2` VARCHAR(45) NULL DEFAULT NULL,
  `monitorarServidor2` VARCHAR(45) NULL DEFAULT NULL,
  `monitorarPorta2` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `staccato`.`usuario_has_config` (
  ...
  `idUsuario` INT(10) UNSIGNED NOT NULL,
  `servidorEmail` VARCHAR(45) NULL DEFAULT NULL,
  `portaEmail` VARCHAR(45) NULL DEFAULT NULL,
  `email` VARCHAR(45) NULL DEFAULT NULL,
  `senhaEmail` VARCHAR(45) NULL DEFAULT NULL,
  `copiaParaEmail` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`idConfig`),
