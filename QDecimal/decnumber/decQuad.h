...
#define decQuadToNumber(dq, dn) decimal128ToNumber(reinterpret_cast<decimal128 *>(const_cast<decQuad *>(dq)), dn)
#define decQuadFromNumber(dq, dn, set) decimal128FromNumber(reinterpret_cast<decimal128 *>(dq), dn, set)
