...
#define decSingleToNumber(dq, dn) decimal32ToNumber(reinterpret_cast<decimal32 *>(const_cast<decSingle *>(dq)), dn)
#define decSingleFromNumber(dq, dn, set) decimal32FromNumber(reinterpret_cast<decimal32 *>(dq), dn, set)
