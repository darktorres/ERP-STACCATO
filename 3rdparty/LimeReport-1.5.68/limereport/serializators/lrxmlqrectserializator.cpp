...
LimeReport::SerializatorIntf *createQRectSerializator(QDomDocument *doc, QDomElement *node) { return new LimeReport::XMLQRectSerializator(doc, node); }
...
QVariant LimeReport::XMLQRectSerializator::loadValue() {
  ...
  rect = QRect(m_node->attribute("x").toInt(), m_node->attribute("y").toInt(), m_node->attribute("width").toInt(), m_node->attribute("height").toInt());
  //}
  return rect;
}
...
QVariant LimeReport::XMLQRectFSerializator::loadValue() {
  ...
  // QDomElement geometryNode = m_node->firstChildElement(name);
  // if (!geometryNode.isNull()){
  rect = QRect(m_node->attribute("x").toDouble(), m_node->attribute("y").toDouble(), m_node->attribute("width").toDouble(), m_node->attribute("height").toDouble());
