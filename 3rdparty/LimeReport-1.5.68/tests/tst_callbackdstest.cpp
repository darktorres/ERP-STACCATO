...
CallbackDSTest::CallbackDSTest() {
  ...
  connect(m_testDS, SIGNAL(getCallbackData(LimeReport::CallbackInfo, QVariant &)), this, SLOT(slotTestOneSlotDS(LimeReport::CallbackInfo, QVariant &)));

  m_test1DS = new LimeReport::CallbackDatasource();
  m_currentRow = -1;
  connect(m_test1DS, SIGNAL(getCallbackData(LimeReport::CallbackInfo, QVariant &)), this, SLOT(slotGetCallbackData(LimeReport::CallbackInfo, QVariant &)));
  connect(m_test1DS, SIGNAL(changePos(LimeReport::CallbackInfo::ChangePosType, bool &)), this, SLOT(slotChangePos(LimeReport::CallbackInfo::ChangePosType, bool &)));
}
...
void CallbackDSTest::slotTestOneSlotDS(LimeReport::CallbackInfo info, QVariant &data) {
  ...
  case LimeReport::CallbackInfo::RowCount: data = 10; break;
...
void CallbackDSTest::slotChangePos(const LimeReport::CallbackInfo::ChangePosType &type, bool &result) {
  if (type == LimeReport::CallbackInfo::First) {
    ...
    if (m_currentRow < 9) m_currentRow++;
