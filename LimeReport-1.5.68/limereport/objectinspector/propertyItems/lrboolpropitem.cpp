...
namespace {
LimeReport::ObjectPropItem *createBoolPropItem(QObject *object, LimeReport::ObjectPropItem::ObjectsList *objects, const QString &name, const QString &displayName, const QVariant &data,
...
QPixmap BoolPropItem::getIndicatorImage(const StyleOptionViewItem &option) {
  ...
  so.rect = QRect(0, 0, QApplication::style()->pixelMetric(QStyle::PM_IndicatorWidth), QApplication::style()->pixelMetric(QStyle::PM_IndicatorHeight));
