...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `staccato`.`view_nfe_entrada` (`idNFe` INT, `chaveAcesso` INT, `CNPJ Dest` INT, `Emitente` INT, `Fornecedor` INT, `NFe` INT, `Status` INT, `Recebido Por` INT, `Data Receb` INT, `GARE` INT, `GARE Pago Em` INT, `OC` INT, `Venda` INT, `nsu` INT, `utilizada` INT, `dataHoraEmissao` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `staccato`.`view_nfe_saida` (`idNFe` INT, `chaveAcesso` INT, `Emitente` INT, `NFe` INT, `Status` INT, `Venda` INT, `CPF/CNPJ` INT, `Cliente` INT, `valor` INT, `dataHoraEmissao` INT);
