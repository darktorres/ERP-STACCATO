...
namespace {
LimeReport::ObjectPropItem *createLocationPropItem(QObject *object, LimeReport::ObjectPropItem::ObjectsList *objects, const QString &name, const QString &displayName, const QVariant &data,
...
bool VARIABLE_IS_NOT_USED registred =
    LimeReport::ObjectPropFactory::instance().registerCreator(LimeReport::APropIdent("itemLocation", "LimeReport::ItemDesignIntf"), QObject::tr("itemLocation"), createLocationPropItem);
} // namespace

LimeReport::ItemLocationPropItem::ItemLocationPropItem(QObject *object, ObjectsList *objects, const QString &name, const QString &displayName, const QVariant &value, ObjectPropItem *parent,
                                                       bool readonly)
...
QString LimeReport::ItemLocationPropItem::displayValue() const { return locationToString(static_cast<LimeReport::ItemDesignIntf::LocationType>(propertyValue().toInt())); }
...
QString LimeReport::ItemLocationPropItem::locationToString(LimeReport::ItemDesignIntf::LocationType location) const { return m_locationMap.key(location); }

LimeReport::ItemDesignIntf::LocationType LimeReport::ItemLocationPropItem::stringToLocation(const QString &locationName) { return m_locationMap.value(locationName); }

void LimeReport::ItemLocationPropItem::slotLocationChanged(const QString &text) {
  if (locationToString(object()->property(propertyName().toLatin1()).toInt()) != text) { object()->setProperty(propertyName().toLatin1(), stringToLocation(text)); }
}
