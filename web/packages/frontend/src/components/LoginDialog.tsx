  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950">
      <div className="bg-slate-800 p-8 rounded-lg shadow-md w-full max-w-md border border-slate-700">
        <h1 className="text-2xl font-bold text-center mb-6 text-slate-50">ERP Login</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              {...register('user')}
              className="mt-1 block w-full px-3 py-2 border border-slate-600 rounded-md bg-slate-700 text-slate-50 shadow-sm focus:outline-none focus:ring-blue-400 focus:border-blue-400"
            />
            {errors.user && (
              <p className="mt-1 text-sm text-red-400">{errors.user.message}</p>
            )}
          </div>
          ...
          <div className="space-y-3 pt-2">
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="rememberPassword" className="ml-2 block text-sm text-slate-300">
                Salvar senha
              </label>
            </div>
            ...
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-blue-600 focus:ring-blue-400 border-slate-600 rounded bg-slate-700"
              />
              <label htmlFor="staging" className="ml-2 block text-sm text-slate-300">
                Ambiente de teste
              </label>
            </div>
          </div>
          ...
          {/* Error message */}
          {error && (
            <div className="p-3 bg-red-950 border border-red-700 rounded-md">
