...
void CadastrarNFe::on_doubleSpinBoxICMSpicms_valueChanged(const double) { //TODO: V524 http://www.viva64.com/en/V524 It is odd that the body of 'on_doubleSpinBoxICMSpicms_valueChanged' function is fully equivalent to the body of 'on_doubleSpinBoxICMSvbc_valueChanged' function.void CadastrarNFe::on_doubleSpinBoxICMSpicms_valueChanged(const double) {
  const auto list = ui->tableItens->selectionModel()->selectedRows();
...
void CadastrarNFe::on_doubleSpinBoxPISppis_valueChanged(const double) { //TODO: V524 http://www.viva64.com/en/V524 It is odd that the body of 'on_doubleSpinBoxPISppis_valueChanged' function is fully equivalent to the body of 'on_doubleSpinBoxPISvbc_valueChanged' function.void CadastrarNFe::on_doubleSpinBoxPISppis_valueChanged(const double) {
  const auto list = ui->tableItens->selectionModel()->selectedRows();
...
void CadastrarNFe::on_doubleSpinBoxCOFINSpcofins_valueChanged(const double) { //TODO: V524 http://www.viva64.com/en/V524 It is odd that the body of 'on_doubleSpinBoxCOFINSpcofins_valueChanged' function is fully equivalent to the body of 'on_doubleSpinBoxCOFINSvbc_valueChanged' function.void CadastrarNFe::on_doubleSpinBoxCOFINSpcofins_valueChanged(const double) {
  const auto list = ui->tableItens->selectionModel()->selectedRows();
...
void CadastrarNFe::on_doubleSpinBoxICMSpicmsst_valueChanged(const double) { //TODO: V524 http://www.viva64.com/en/V524 It is odd that the body of 'on_doubleSpinBoxICMSpicmsst_valueChanged' function is fully equivalent to the body of 'on_doubleSpinBoxICMSvbcst_valueChanged' function.void CadastrarNFe::on_doubleSpinBoxICMSpicmsst_valueChanged(const double) {
  const auto list = ui->tableItens->selectionModel()->selectedRows();
