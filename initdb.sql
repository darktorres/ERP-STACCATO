...
CREATE TABLE IF NOT EXISTS `staccato`.`orcamento_atelier` (
  `idOrcamentoAtelier` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `idOrcamento` VARCHAR(10) NOT NULL COMMENT 'Format: YY + sequence + A (e.g., 25751A)',
  `idLoja` INT(10) UNSIGNED NOT NULL,
  ...
  `clientePlaceholder` VARCHAR(200) NULL DEFAULT NULL COMMENT 'Manual client name when not selecting from system',
  `idProfissional` INT(10) UNSIGNED NULL DEFAULT NULL COMMENT 'FK to usuario table for professional/architect selection',
  ...
  `sections` JSON NOT NULL COMMENT 'Array of quote sections with room, material, product, details, notes',
  `outrosItens` JSON NULL DEFAULT NULL COMMENT 'Array of additional items like shipping, measurement fees',
  `termsOverride` JSON NULL DEFAULT NULL COMMENT 'Custom terms if different from default template',
  `subtotal` DECIMAL(15,4) NOT NULL DEFAULT '0.0000',
  `total` DECIMAL(15,4) NOT NULL DEFAULT '0.0000',
  `status` ENUM('RASCUNHO', 'ATIVO', 'APROVADO', 'CANCELADO') NOT NULL DEFAULT 'RASCUNHO',
  `created` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `lastUpdated` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`idOrcamentoAtelier`),
  UNIQUE INDEX `uk_orcamento_loja` (`idOrcamento` ASC, `idLoja` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `staccato`.`template_produto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `staccato`.`template_produto` (
  ...
  `roomName` VARCHAR(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL COMMENT 'Environment name (e.g., \"Cozinha\")',
  `productType` VARCHAR(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL COMMENT 'Product type (e.g., \"Bancada\", \"Piso\")',
  ...
  `squareMeters` VARCHAR(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL COMMENT 'Optional area specification',
  `productDescription` VARCHAR(1000) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL COMMENT 'Product description',
  `price` DECIMAL(15,4) NOT NULL COMMENT 'Price in Brazilian Real (DECIMAL for precision)',
  `details` JSON NULL DEFAULT NULL COMMENT 'JSON array of detail items',
  `notes` JSON NULL DEFAULT NULL COMMENT 'JSON array of special notes/conditions',
  `created` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'When template was created',
  `lastUsed` TIMESTAMP NULL DEFAULT NULL COMMENT 'When template was last used in a quote',
  `usageCount` INT(11) NULL DEFAULT '0' COMMENT 'Number of times template has been used',
  ...
  INDEX `idx_lastUsed` (`lastUsed` ASC) COMMENT '\'Find recently used templates\'' VISIBLE,
  INDEX `idx_usageCount` (`usageCount` ASC) COMMENT '\'Find popular templates\'' VISIBLE,
