...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `staccato`.`view_consistencia_vp1_v_total` (`idVenda` INT, `codComercial` INT, `totalVenda` INT, `totalProdutos` INT, `created` INT);
