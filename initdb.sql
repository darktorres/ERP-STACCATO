...
BEGIN
	INSERT INTO comissao (idVendaProduto1, `Loja`, `Vendedor`, `idUsuario`, `idUsuarioConsultor`, `idVenda`, `Mês`, `Faturamento`, `Comissão`, `%`, `fornecedor`, `especialidade`) SELECT 
    vp.idVendaProduto1,
    `l`.`descricao` AS `Loja`,
    `u`.`nome` AS `Vendedor`,
