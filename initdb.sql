...
-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_relatorio_vendedor2`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_relatorio_vendedor2` (`Loja` INT, `Vendedor` INT, `idUsuario` INT, `Faturamento` INT, `Comissão` INT, `%` INT, `Mês` INT);
