...
public:
  void registerFunctionCreator(const QString &functionName, GroupFunctionCreator *creator) { m_creators.insert(functionName, creator); }
...
class CountGroupFunction : public GroupFunction {
  Q_OBJECT
public:
  CountGroupFunction(const QString &expression, const QString &dataBandName, DataSourceManager *dataManager) : GroupFunction(expression, dataBandName, dataManager) { setName("COUNT"); }
...
class SumGroupFunction : public GroupFunction {
  Q_OBJECT
public:
  SumGroupFunction(const QString &expression, const QString &dataBandName, DataSourceManager *dataManager) : GroupFunction(expression, dataBandName, dataManager) { setName("SUM"); }
...
class AvgGroupFunction : public GroupFunction {
  Q_OBJECT
public:
  AvgGroupFunction(const QString &expression, const QString &dataBandName, DataSourceManager *dataManager) : GroupFunction(expression, dataBandName, dataManager) { setName("AVG"); }
...
class MinGroupFunction : public GroupFunction {
  Q_OBJECT
public:
  MinGroupFunction(const QString &expression, const QString &dataBandName, DataSourceManager *dataManager) : GroupFunction(expression, dataBandName, dataManager) { setName("MIN"); }
...
class MaxGroupFunction : public GroupFunction {
  Q_OBJECT
public:
  MaxGroupFunction(const QString &expression, const QString &dataBandName, DataSourceManager *dataManager) : GroupFunction(expression, dataBandName, dataManager) { setName("MAX"); }
...
template <typename T> GroupFunction *ConstructorGroupFunctionCreator<T>::createFunction(const QString &expression, const QString &dataBandName, DataSourceManager *dataManager) {
