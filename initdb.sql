...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `staccato`.`view_gares` (`idNFe` INT, `referencia` INT, `status` INT, `valor` INT, `numeroNFe` INT, `cnpjOrig` INT, `dataPagamento` INT, `dataRealizado` INT);
