...
QColor ObjectInspectorWidget::getColor(const int index) const { return m_colors[index]; }
...
ObjectPropItem *ObjectInspectorWidget::nodeFromIndex(QModelIndex index) const { return static_cast<LimeReport::ObjectPropItem *>(index.internalPointer()); }
