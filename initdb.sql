...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `staccato`.`view_faturamento` (`ordemCompra` INT, `fornecedor` INT, `data` INT, `produtos` INT, `total` INT, `idCompra` INT, `dataPrevFat` INT, `vendedor` INT, `idVenda` INT, `representacao` INT, `dataFollowup` INT, `observacao` INT);
