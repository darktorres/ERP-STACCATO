...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `staccato`.`view_calendario_carga` (`idVeiculo` INT, `idEvento` INT, `dataPrevEnt` INT, `modelo` INT, `idNFeSaida` INT, `idNFeFutura` INT, `NFe Status` INT, `numeroNFe` INT, `NFe Futura` INT, `idVenda` INT, `status` INT, `produtos` INT, `kg` INT);
