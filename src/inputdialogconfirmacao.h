...
private:
  ...
  // methods
  auto cadastrar() -> bool;
  auto criarReposicaoCliente(SqlTableModel &modelVendaProduto, const double caixasDefeito, const double unCaixa) -> bool;
  ...
  auto gerarCreditoCliente(const SqlTableModel &modelVendaProduto, const double caixasDefeito, const double unCaixa) -> bool;
