...
CREATE TABLE IF NOT EXISTS `staccato`.`loja` (
  ...
  `proximaConsultaPermitida` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
...
-- -----------------------------------------------------
-- Table `staccato`.`qr_code_product_mapping`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `staccato`.`qr_code_product_mapping` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `qr_code_data` VARCHAR(512) NOT NULL COMMENT 'The full data/URL from the supplier QR code',
  `idProduto` INT(11) NOT NULL COMMENT 'The internal product ID from the `produto` table',
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `idx_qr_code_data` (`qr_code_data` ASC) VISIBLE,
  INDEX `idx_idProduto` (`idProduto` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8mb4
