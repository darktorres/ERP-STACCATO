# Schema Visual Overview & Architecture Guide

> **Companion to**: [02-schema-redesenhado.md](./02-schema-redesenhado.md)
> **Type**: Visual Architecture + Design Patterns
> **Use this for**: Understanding design principles, system flows, Event Sourcing patterns, allocation models

This document provides visual flowcharts and conceptual explanations to complement
the SQL schema definition in 02-schema-redesenhado.md.
