...
namespace {
LimeReport::ObjectPropItem *createSvgPropItem(QObject *object, LimeReport::ObjectPropItem::ObjectsList *objects, const QString &name, const QString &displayName, const QVariant &data,
...
bool VARIABLE_IS_NOT_USED registredImageProp =
    LimeReport::ObjectPropFactory::instance().registerCreator(LimeReport::APropIdent("image", "LimeReport::SVGItem"), QObject::tr("image"), createSvgPropItem);
} // namespace
...
QString SvgPropItem::displayValue() const { return (propertyValue().isNull()) ? "" : QObject::tr("image"); }
...
QIcon SvgPropItem::iconValue() const { return QIcon(QPixmap::fromImage(propertyValue().value<QImage>())); }
