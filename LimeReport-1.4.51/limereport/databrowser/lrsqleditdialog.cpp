...
void SQLEditDialog::slotPreviewData() {
  ...
  m_previewModel = m_datasources->previewSQL(ConnectionDesc::connectionNameForReport(ui->cbbConnection->currentText()), ui->textEditSQL->toPlainText(), ui->leMaster->text());
  if (m_previewModel) {
