...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `staccato`.`view_galpao` (`idEstoque_idConsumo` INT, `idEstoque` INT, `descricao` INT, `status` INT, `idVenda` INT, `codComercial` INT, `numeroNFe` INT, `idNFe` INT, `caixas` INT, `quant` INT, `idBloco` INT, `idVendaProduto2` INT, `lote` INT, `tipo` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `staccato`.`view_nfe_entrada` (`idNFe` INT, `chaveAcesso` INT, `CNPJ Dest` INT, `Emitente` INT, `Fornecedor` INT, `NFe` INT, `Status` INT, `Recebido Por` INT, `Data Receb` INT, `GARE` INT, `GARE Pago Em` INT, `OC` INT, `Venda` INT, `nsu` INT, `utilizada` INT, `Importado em` INT);
