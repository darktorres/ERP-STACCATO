...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_calendario_produto` (`idEvento` INT, `idVenda` INT, `idVendaProduto` INT, `fornecedor` INT, `produto` INT, `caixas` INT, `quant` INT, `kg` INT, `un` INT, `idEstoque` INT, `lote` INT, `local` INT, `bloco` INT);
